...
- **Long-term memory**: Persist context across sessions and threads with the [Memory Store](/oss/javascript/deepagents/memory)
...
- **Production deployment**: Deploy via [`deepagents deploy`](/oss/javascript/deepagents/deploy) or self-host with the Agent Server
