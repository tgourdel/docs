...
To create LangChain [Document](https://reference.langchain.com/javascript/langchain-core/documents/Document) objects (e.g., for use in downstream tasks), use `.createDocuments`.
