...
low-latency embedding models. Since LangChain requires passing in a [`Embeddings`](https://reference.langchain.com/javascript/langchain-core/embeddings/Embeddings) instance, we pass in `FakeEmbeddings`.

**Note:** If you pass in an [`Embeddings`](https://reference.langchain.com/javascript/langchain-core/embeddings/Embeddings) instance other than `FakeEmbeddings`, this class will be used to embed documents.
