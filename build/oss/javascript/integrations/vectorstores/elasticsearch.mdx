...
For more information, see [vector search in Elasticsearch](https://www.elastic.co/guide/en/elasticsearch/reference/current/knn-search.html).
...
For connecting to Elastic Cloud you can read the [Kibana API key documentation](https://www.elastic.co/guide/en/kibana/current/api-keys.html) for obtaining an API key.
