...
Since LangChain requires passing in a [`Embeddings`](https://reference.langchain.com/javascript/langchain-core/embeddings/Embeddings) instance, we pass in `FakeEmbeddings`.
