...
<Tip>
    **API Reference**
    ...
    For detailed documentation of all features and configuration options, head to the [ChatOpenRouter API reference](https://api.js.langchain.com/classes/langchain_openrouter.ChatOpenRouter.html).
</Tip>
...
| Class | Package | Serializable | [PY support](/oss/javascript/integrations/chat/openrouter) | Downloads | Version |
| :--- | :--- | :---: |  :---: | :---: | :---: |
...
For detailed documentation of all `ChatOpenRouter` features and configurations, head to the [ChatOpenRouter API reference](https://api.js.langchain.com/classes/langchain_openrouter.ChatOpenRouter.html).
