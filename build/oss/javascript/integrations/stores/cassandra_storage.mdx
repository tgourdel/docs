...
This example demonstrates how to setup chat history storage using the `CassandraKVStore` [`BaseStore`](https://reference.langchain.com/javascript/langchain-core/stores/BaseStore) integration. Note there is a `CassandraChatMessageHistory`
