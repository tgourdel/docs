...
| Interrupts (HITL) | ❌ | ✅ | ✅ |
| Multi-turn memory | ❌ | ❌ | ✅ |
| Multiple calls (different subgraphs) | ✅ | ✅ | <Tooltip tip="Calls to multiple stateful subgraphs in the same node can cause namespace conflicts. Workarounds are available.">⚠️</Tooltip> |
