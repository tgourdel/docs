...
You also need to pass in an [`Embeddings`](https://reference.langchain.com/python/langchain-core/embeddings/embeddings/Embeddings) object which can turn text into vector embeddings.
...
When inserting documents, first they are embedded using the [`Embeddings`](https://reference.langchain.com/python/langchain-core/embeddings/embeddings/Embeddings) object.
