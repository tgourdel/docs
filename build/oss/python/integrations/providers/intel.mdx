...
* Install optimum-intel as shown in the [optimum-intel installation guide](https://github.com/huggingface/optimum-intel).
* Install IPEX as shown in the [IPEX installation guide](https://intel.github.io/intel-extension-for-pytorch/index.html#installation?platform=cpu&version=v2.2.0%2Bcpu).
