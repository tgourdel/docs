...
We can add python function as actions as shown in the [Robocorp actions documentation](https://github.com/robocorp/robocorp/tree/master/actions#describe-your-action).
