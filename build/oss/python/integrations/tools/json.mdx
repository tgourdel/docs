...
In the below example, we are using the OpenAPI spec for the OpenAI API, which you can find in the [OpenAI OpenAPI spec repository](https://github.com/openai/openai-openapi/blob/master/openapi.yaml).
