...
Read more about [OpenAI file names for multimodal messages](/oss/python/langchain/messages#multimodal#example-openai-file-names).

Refer to examples in the [PDF documents how-to guide](/oss/python/langchain/messages#multimodal#documents-pdf).
...
Refer to examples in the [audio how-to guide](/oss/python/langchain/messages#multimodal#audio).
