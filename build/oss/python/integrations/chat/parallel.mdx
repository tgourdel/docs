...
<Tip>
    **API Reference**
    ...
    For detailed documentation of all features and configuration options, head to the [`ChatParallelWeb`](https://reference.langchain.com/python/langchain-parallel/chat_models/ChatParallelWeb) API reference.
</Tip>
...
See the [`ChatParallelWeb`](https://reference.langchain.com/python/langchain-parallel/chat_models/ChatParallelWeb) API Reference for the full set of available model parameters.
...
For detailed documentation of all features and configuration options, head to the [`ChatParallelWeb`](https://reference.langchain.com/python/langchain-parallel/chat_models/ChatParallelWeb) API reference or or the [Parallel chat API quickstart](https://docs.parallel.ai/chat-api/chat-quickstart).
