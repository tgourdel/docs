...
This doc will help you get started with OCI Generative AI [embedding models](/oss/python/integrations/text_embedding). Oracle Cloud Infrastructure (OCI) Generative AI provides state-of-the-art embedding models for text and images, enabling semantic search, RAG, clustering, and cross-modal applications.
...
- [Embeddings Guide](/oss/python/integrations/text_embedding)
