...
- There are several embedding models available in CLOVA Studio. See the [CLOVA Studio embedding API documentation](https://guide.ncloud-docs.com/docs/en/clovastudio-explorer03#임베딩API) for further details.
