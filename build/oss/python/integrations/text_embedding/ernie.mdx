...
You can find documentation for `QianfanEmbeddingsEndpoint` in the [Baidu Qianfan endpoint integration](/oss/python/integrations/text_embedding/baidu_qianfan_endpoint/).
