...
The `metadata` for each [`Document`](https://reference.langchain.com/python/langchain-core/documents/base/Document) (really, a chunk of an actual PDF, DOC or DOCX) contains some useful additional information:
