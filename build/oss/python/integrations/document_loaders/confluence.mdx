...
This loader allows you to fetch and process Confluence pages into [`Document`](https://reference.langchain.com/python/langchain-core/documents/base/Document) objects.
