...
To use MongoDB Atlas, you must first deploy a cluster. To get started, sign up for free to Atlas [here](https://www.mongodb.com/cloud/atlas/register).
...
For detailed documentation of all `MongoDB` features and configurations for LangChain, head to the API reference: [langchain-mongodb](https://langchain-mongodb.readthedocs.io/en/latest/langchain_mongodb/api_docs.html)
