...
We will connect to the index using a [`VectorStore`](https://reference.langchain.com/python/langchain-core/vectorstores/base/VectorStore) client, which implements the `similarity_search` function to retrieve matching documents.
