...
The most direct way to query the data is to search against the index. We can do that as follows using the [`VectorStore`](https://reference.langchain.com/python/langchain-core/vectorstores/base/VectorStore) API:
