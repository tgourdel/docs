...
See the [LangGraph streaming docs](/oss/python/langgraph/streaming#v2-streaming-format) for more details on the v2 format, including type narrowing, Pydantic/dataclass coercion, and subgraph streaming.
