...
In the [Playground](/langsmith/prompt-engineering-concepts#playground), Polly helps you edit and optimize your [prompts](/langsmith/prompt-engineering-concepts#prompt-in-langsmith). Use automated options like **Optimize prompt**, **Generate a tool**, or **Generate an output schema**, or give Polly custom instructions for editing your prompt.
