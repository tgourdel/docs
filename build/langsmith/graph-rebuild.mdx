...
You can use the factory function to customize or disable tracing for a specific graph. See [Conditional tracing: Customize tracing in deployed graphs](/langsmith/conditional-tracing#customize-tracing-in-langsmith-deployment) for examples.
