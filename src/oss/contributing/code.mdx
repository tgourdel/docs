    ...
    <Tab title="LangChain" icon="link">
        ...
        <AccordionGroup>
            ...
            <Accordion title="Partner packages">
                ...
                - **[`langchain-anthropic`](https://github.com/langchain-ai/langchain/tree/master/libs/partners/anthropic#readme)**: [Anthropic](/oss/integrations/providers/anthropic) integrations
                ...
                Many partner packages are in external repositories. Please check the [list of integrations](/oss/integrations/providers/overview) for details.
                :::
                :::js
                ...
                - **[`@langchain/google`](https://github.com/langchain-ai/langchainjs/tree/main/libs/providers/langchain-google#readme)**: [Google](/oss/integrations/providers/google) integrations
                :::
