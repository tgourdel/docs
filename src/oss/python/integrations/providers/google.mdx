...
<Columns cols={1}>
    <Card title="GoogleGenerativeAIEmbeddings" href="/oss/integrations/text_embedding/google_generative_ai" cta="Get started" icon="stack-2" arrow>
...
<Note>
    **For Gemini models**, use [`ChatGoogleGenerativeAI`](/oss/integrations/chat/google_generative_ai) from `langchain-google-genai`. The classes below focus on **Vertex AI platform services** not available in the consolidated SDK.
</Note>
...
<AccordionGroup>
    <Accordion title="VertexAIEmbeddings (deprecated)">
        **Deprecated** — Use [`GoogleGenerativeAIEmbeddings`](/oss/integrations/text_embedding/google_generative_ai) instead.
...
<AccordionGroup>
    ...
    <Accordion title="Google BigQuery">
        See the [documentation](/oss/integrations/callbacks/google_bigquery) for more details.
...
<Columns cols={2}>
    <Card title="Gmail" icon="mail" href="/oss/integrations/chat_loaders/google_gmail" cta="Get started" arrow>
...
<Columns cols={2}>
    <Card title="SearchApi" icon="search" href="/oss/integrations/tools/searchapi" cta="Get started" arrow>
        API access to Google search results, YouTube, and more.
    </Card>
    <Card title="SerpApi" icon="search" href="/oss/integrations/tools/serpapi" cta="Get started" arrow>
...
<Columns cols={2}>
    <Card title="Search tool" icon="brand-youtube" href="/oss/integrations/tools/youtube" cta="Get started" arrow>
        Search YouTube videos without the official API.
    </Card>
    <Card title="Audio loader" icon="brand-youtube" href="/oss/integrations/document_loaders/youtube_audio" cta="Get started" arrow>
        Download audio from YouTube videos.
    </Card>
    <Card title="Transcripts loader" icon="brand-youtube" href="/oss/integrations/document_loaders/youtube_transcript" cta="Get started" arrow>
